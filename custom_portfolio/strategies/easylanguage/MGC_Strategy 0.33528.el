//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.33528
//
...
inputs:
	...
	RSIPeriod1(20),
	RSIPeriod2(50),
	IndicatorCrsMAPrd1(9),
	ExitAfterBars1(120),
	ProfitTargetCoef1(15.1),
	StopLossCoef1(1.9),
...
//------------------------------------------------------------------
Value1= SQ_RSI(MedianPrice, RSIPeriod1)[1+1];
Value2= SQ_RSI(MedianPrice, RSIPeriod2)[1+1];
Value3= SQ_RSI(MedianPrice, RSIPeriod1)[1];
Value4= SQ_RSI(MedianPrice, RSIPeriod2)[1];
Value5= Low[1];
Value6= Close[1];
LongEntrySignal = ((((Value1 < Value2) and (Value3 > Value4)) and (Value5 < Value6)) and SQ_IndicatorCrossesAboveMA(Close[1],IndicatorCrsMAPrd1,1)[1]);
