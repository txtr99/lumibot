//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.60689
//
...
inputs:
	// Strategy variables
	MagicNumber(11111),
	IndicatorCrsMAPrd1(39),
	MACDFast1(24),
	MACDSlow1(52),
	MACDSmooth1(9),
	EMAPeriod1(19),
	ExitAfterBars1(170),
	ProfitTargetCoef1(9.6),
	StopLossCoef1(1.9),
...
//------------------------------------------------------------------
Value1= Low[1];
Value2= SQ_EMA(Open, EMAPeriod1)[1];
LongEntrySignal = (SQ_IndicatorCrossesBelowMA(SQ_MACD(Close, MACDFast1, MACDSlow1, MACDSmooth1, 1)[1],IndicatorCrsMAPrd1,1)[1] and (Value1 < Value2));
