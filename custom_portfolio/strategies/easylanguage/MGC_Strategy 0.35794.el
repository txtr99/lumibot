//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.35794
//
...
inputs:
	// Strategy variables
	MagicNumber(11111),
	IndicatorCrsMAPrd1(41),
	EMAPeriod1(20),
	ExitAfterBars1(60),
	ProfitTargetCoef1(10.3),
	StopLossCoef1(1.5),
...
//------------------------------------------------------------------
Value1= Close[1+1];
Value2= SQ_EMA(Close, EMAPeriod1)[1+1];
Value3= Close[1];
Value4= SQ_EMA(Close, EMAPeriod1)[1];
LongEntrySignal = (SQ_IndicatorCrossesBelowMA(High[1],IndicatorCrsMAPrd1,3)[1] and ((Value1 < Value2) and (Value3 > Value4)));
