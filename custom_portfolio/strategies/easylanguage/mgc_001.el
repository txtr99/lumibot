//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.1606
//
...
inputs:
	// Strategy variables
	MagicNumber(11111),
	IndicatorCrsMAPrd1(49),
	MACDFast1(16),
	MACDSlow1(37),
	MACDSmooth1(10),
	ExitAfterBars1(180),
	ProfitTargetCoef1(15.5),
	StopLossCoef1(2.1),
...
//------------------------------------------------------------------
LongEntrySignal = SQ_IndicatorCrossesBelowMA(SQ_MACD(MedianPrice, MACDFast1, MACDSlow1, MACDSmooth1, 0)[1],IndicatorCrsMAPrd1,3)[1];
