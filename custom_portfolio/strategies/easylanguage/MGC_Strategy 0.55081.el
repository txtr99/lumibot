//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.55081
//
...
Value5= SQ_EMA(WeightedClose, EMAPeriod1)[1];
Value6= SQ_EMA(Low, EMAPeriod2)[1];
LongEntrySignal = (((Value1 < Value2) and (Value3 > Value4)) and (Value5 < Value6));
