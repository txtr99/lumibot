//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.35409
//
...
//------------------------------------------------------------------
Value1= SQ_EMA(Close, EMAPeriod1)[1+1];
Value2= Close[1+1];
Value3= SQ_EMA(Close, EMAPeriod1)[1];
Value4= Close[1];
LongEntrySignal = (SQ_IndicatorCrossesBelowMA(Low[1],IndicatorCrsMAPrd1,3)[1] and ((Value1 > Value2) and (Value3 < Value4)));
