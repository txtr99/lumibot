//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.12389
//
...
inputs:
	// Strategy variables
	MagicNumber(11111),
	IndicatorMAPeriod1(5),
	EMAPeriod1(14),
	MACDFast1(8),
	MACDSlow1(17),
	MACDSmooth1(9),
	ExitAfterBars1(120),
	ProfitTargetCoef1(13.1),
	StopLossCoef1(2.2),
...
Value1= High[1];
Value2= Close[1];
LongEntrySignal = ((SQ_IsIndicatorBelowMA(SQ_EMA(Close, EMAPeriod1)[1],IndicatorMAPeriod1,1)[1] and (Value1 > Value2)) and (SQ_IsFalling(SQ_MACD(Close, MACDFast1, MACDSlow1, MACDSmooth1, 0)[1], 12, false)[1] = 1));
