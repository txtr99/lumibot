//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.38080
//
...
Value2= SQ_MACD(Close, MACDFast2, MACDSlow2, MACDSmooth1, 1)[1+1];
Value3= SQ_MACD(Close, MACDFast1, MACDSlow1, MACDSmooth1, 0)[1];
Value4= SQ_MACD(Close, MACDFast2, MACDSlow2, MACDSmooth1, 1)[1];
LongEntrySignal = (SQ_IsIndicatorAboveMA(SQ_MACD(Close, MACDFast1, MACDSlow1, MACDSmooth1, 0)[1],IndicatorMAPeriod1,3)[1] and ((Value1 < Value2) and (Value3 > Value4)));
