//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.71227
//
...
//------------------------------------------------------------------
Value1= SQ_RSI(High, RSIPeriod1)[1+1];
Value2= SQ_RSI(Close, RSIPeriod2)[1+1];
Value3= SQ_RSI(High, RSIPeriod1)[1];
Value4= SQ_RSI(Close, RSIPeriod2)[1];
Value5= SQ_EMA(Open, EMAPeriod1)[1+1];
Value6= Close[1+1];
Value7= SQ_EMA(Open, EMAPeriod1)[1];
Value8= Close[1];
LongEntrySignal = (((Value1 < Value2) and (Value3 > Value4)) and ((Value5 < Value6) and (Value7 > Value8)));
