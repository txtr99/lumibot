//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.29926
//
...
inputs:
	// Strategy variables
	MagicNumber(11111),
	IndicatorMAPeriod1(20),
	RSIPeriod1(14),
	EMAPeriod1(30),
	EMAPeriod2(50),
	RSIPeriod2(30),
	ExitAfterBars1(50),
	ProfitTargetCoef1(10.8),
	StopLossCoef1(1.9),
...
//------------------------------------------------------------------
Value1= SQ_RSI(Low, RSIPeriod1)[1+1];
Value2= SQ_RSI(MedianPrice, RSIPeriod2)[1+1];
Value3= SQ_RSI(Low, RSIPeriod1)[1];
Value4= SQ_RSI(MedianPrice, RSIPeriod2)[1];
LongEntrySignal = ((SQ_IsIndicatorAboveMA(SQ_RSI(TypicalPrice, RSIPeriod1)[1],IndicatorMAPeriod1,3)[1] and (SQ_IsLowerCount(SQ_EMA(TypicalPrice, EMAPeriod1)[1],SQ_EMA(Low, EMAPeriod2)[1], 2, true)[1] = 1)) and ((Value1 < Value2) and (Value3 > Value4)));
