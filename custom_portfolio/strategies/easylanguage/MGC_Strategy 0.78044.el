//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.78044
//
...
inputs:
	// Strategy variables
	MagicNumber(11111),
	IndicatorCrsMAPrd1(38),
	RSIPeriod1(30),
	MACDFast1(12),
	MACDSlow1(26),
	MACDSmooth1(9),
	ExitAfterBars1(130),
	ProfitTargetCoef1(7.5),
	StopLossCoef1(1.5),
...
//------------------------------------------------------------------
Value1= SQ_MACD(Close, MACDFast1, MACDSlow1, MACDSmooth1, 1)[1+1];
Value2= SQ_MACD(Close, MACDFast1, MACDSlow1, MACDSmooth1, 0)[1+1];
Value3= SQ_MACD(Close, MACDFast1, MACDSlow1, MACDSmooth1, 1)[1];
Value4= SQ_MACD(Close, MACDFast1, MACDSlow1, MACDSmooth1, 0)[1];
LongEntrySignal = (SQ_IndicatorCrossesAboveMA(SQ_RSI(Close, RSIPeriod1)[1],IndicatorCrsMAPrd1,4)[1] and ((Value1 > Value2) and (Value3 < Value4)));
