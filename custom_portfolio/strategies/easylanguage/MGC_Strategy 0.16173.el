//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.16173
//
//   Generated by StrategyQuant X Build 143
//   at 12/04/2025 08:14
//  
//   Backtested on @GR_MGC_Gold_Micro / M5, 2024.01.01 - 2025.12.03 
//
...
inputs:
	...
	MagicNumber(11111),
	EMAPeriod1(30),
	IndicatorMAPeriod1(22),
	RSIPeriod1(14),
	EMAPeriod2(24),
	ExitAfterBars1(100),
	ProfitTargetCoef1(17.8),
	StopLossCoef1(2.2),
...
//------------------------------------------------------------------
Value1= Low[1+1];
Value2= SQ_EMA(MedianPrice, EMAPeriod1)[1+1];
Value3= Low[1];
Value4= SQ_EMA(MedianPrice, EMAPeriod1)[1];
LongEntrySignal = ((((Value1 > Value2) and (Value3 < Value4)) and SQ_IsIndicatorBelowMA(SQ_RSI(High, RSIPeriod1)[1],IndicatorMAPeriod1,3)[1]) and (SQ_IsGreaterCount(Low[1],SQ_EMA(Low, EMAPeriod2)[1], 7, false)[1] = 1));
