//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.4515
//
...
Value2= SQ_MACD(Close, MACDFast1, MACDSlow1, MACDSmooth1, 1)[1];
LongEntrySignal = ((Value1 > -0.2) and (Value2 < -0.2));
