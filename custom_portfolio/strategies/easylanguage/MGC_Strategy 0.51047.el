//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.51047
//
...
//------------------------------------------------------------------
Value1= SQ_MACD(Low, MACDFast1, MACDSlow1, MACDSmooth1, 0)[1+1];
Value2= SQ_MACD(Close, MACDFast2, MACDSlow2, MACDSmooth2, 1)[1+1];
Value3= SQ_MACD(Low, MACDFast1, MACDSlow1, MACDSmooth1, 0)[1];
Value4= SQ_MACD(Close, MACDFast2, MACDSlow2, MACDSmooth2, 1)[1];
