//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.84756
//
...
//------------------------------------------------------------------
Value1= SQ_RSI(Open, RSIPeriod1)[1+1];
Value2= SQ_RSI(Open, RSIPeriod1)[1];
LongEntrySignal = ((Value1 < 58.8) and (Value2 > 58.8));
