//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.3222
//
...
inputs:
	// Strategy variables
	MagicNumber(11111),
	IndicatorMAPeriod1(8),
	EMAPeriod1(30),
	MACDFast1(12),
	MACDSlow1(26),
	MACDSmooth1(9),
	ExitAfterBars1(150),
	ProfitTargetCoef1(19.3),
	StopLossCoef1(2.1),
...
LongEntrySignal = (SQ_IsIndicatorAboveMA(SQ_EMA(MedianPrice, EMAPeriod1)[1],IndicatorMAPeriod1,3)[1] and ((Value1 > 0.3) and (Value2 < 0.3)));
