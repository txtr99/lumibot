//------------------------------------------------------------------
// EasyLanguage Code for Tradestation / MultiCharts of Strategy 0.8023
//
...
inputs:
	// Strategy variables
	MagicNumber(11111),
	IndicatorMAPeriod1(45),
	RSIPeriod1(26),
	IndicatorCrsMAPrd1(47),
	IndicatorCrsMAPrd2(9),
	ExitAfterBars1(110),
	ProfitTargetCoef1(13.3),
	StopLossCoef1(1.5),
...
//------------------------------------------------------------------
LongEntrySignal = ((SQ_IsIndicatorBelowMA(SQ_RSI(TypicalPrice, RSIPeriod1)[1],IndicatorMAPeriod1,1)[1] and SQ_IndicatorCrossesAboveMA(Close[1],IndicatorCrsMAPrd1,4)[1]) and SQ_IndicatorCrossesAboveMA(High[1],IndicatorCrsMAPrd2,1)[1]);
